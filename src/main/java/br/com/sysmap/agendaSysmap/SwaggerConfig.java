...
public class SwaggerConfig {
    ...
    private ApiInfo metaData() {
        return new ApiInfoBuilder()
                .title("API REST - Application AgendaSysmap")
                .description("Através desta API será possível o cadastro de usuarios e compromissos")
                .termsOfServiceUrl("https://github.com/mauricio-melo")
                .contact(new Contact("Mauricio Ribeiro de Melo", "https://www.linkedin.com/in/mauriciormelo/", "mauriciomelo.contato@gmail.com"))
                .license("Licença")
